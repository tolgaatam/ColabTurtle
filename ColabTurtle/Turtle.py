...
def _arctoNewPosition(r,new_pos):
    ...
    start_pos = turtle_pos
    if is_pen_down:  #removing fill="transparent"
        svg_lines_string += """<path d="M {x1} {y1} A {rx} {ry} 0 0 {s} {x2} {y2}" stroke-linecap="round" style="stroke:{pen_color};stroke-width:{pen_width}"/>""".format(
